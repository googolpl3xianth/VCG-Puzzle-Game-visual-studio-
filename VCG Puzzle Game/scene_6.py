...
def main(gameManager):  # first scene
  ...
  nNPC = spr.NPC(pg.transform.scale(pg.image.load("sprites/NPCs/Mentor.png").convert_alpha(), (int(gameManager.tileSize[0]), int(gameManager.tileSize[1]) * 2)), (4, 6), (["Are you trying to escape?", "If you give me 5 coins I'll help you out", "What? You don't have 5 coins?", "Tough luck", "What? You asking for help?", "Well I know there is a coin in each floor before", "Just think outside the box", "or as far out as you can at least"], ["here is the map", "I wish you good luck"]), len(gameManager.inventoryImage.coins.names) >= 5 or gameManager.inventoryImage.searchInv("map6"), gameManager)
  ...
  kill_shadow = (
      spr.killShadow((0, 0, gameManager.screenWidth / gameManager.tileSize[0],
                     ...
                     gameManager))
  all_sprites.add(background, kill_shadow, door_group, nNPC, gameManager.Player,)
