...
def main(gameManager):  # first scene
  ...
  text_group = pg.sprite.Group(
      spr.text((4, 7), 12, "return to the beginning", gameManager, gameManager.tileSize[1],
               (0, 255, 0)),
      spr.text((4, 5), 12, "there are 2 coins to collect in scene_1 and 2",
               gameManager, gameManager.tileSize[1], (0, 255, 0)),
      spr.text((4, 3), 12, "press esc then g", gameManager, gameManager.tileSize[1], (0, 255, 0)))
